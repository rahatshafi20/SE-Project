...
const Footer = () => {
  return (
    <footer className="bg-secondary/50 border-t border-border/50 py-10 px-6 mt-auto">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
        <div className="space-y-4">
          <div className="flex items-center space-x-2">
            <Car className="h-5 w-5 text-primary" />
            <span className="font-medium">ParkEase</span>
          </div>
      ...
      <div className="max-w-7xl mx-auto pt-8 mt-8 border-t border-border/50 flex flex-col md:flex-row justify-between items-center">
